...
namespace Czar.Cms.Test 
{
    public class Common
    {
        ...
        public static IServiceProvider BuildServiceForSqlServer()
        {
            ...
            {
                options.ConnectionString = "Data Source=.;Initial Catalog=ChenLiao;User ID=sa;Password=123456;Persist Security Info=True;Max Pool Size=50;Min Pool Size=0;Connection Lifetime=300;";
                options.DbType = DatabaseType.SqlServer.ToString();//数据库类型是SqlServer,其他数据类型参照枚举DatabaseType
                options.Author = "张毅";//作者名称
                options.OutputPath = "D:\\代码生成";//模板代码生成的路径
