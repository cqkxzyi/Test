...
//           All rights reserved
// 
//           filename : CustomCruderServiceBase.cs
//           description :
// 
...
namespace Magicodes.Admin.Application.Core
{
    ...
    [AbpAuthorize]
    public abstract class CustomCruderServiceBase<TEntity, TEntityDto, TPrimaryKey, TGetAllInput, TCreateInput,
        TUpdateInput, TExportDto> : CustomCrudeServiceBase<TEntity, TEntityDto, TPrimaryKey, TGetAllInput, TCreateInput,
        TUpdateInput, TExportDto>
...

    {
        ...
        public virtual async Task Restore(TPrimaryKey id)
        {
            ...
            using (UnitOfWorkManager.Current.DisableFilter(AbpDataFilters.SoftDelete))
            {
                ...
                if (model is ISoftDelete delete) delete.IsDeleted = false;
