...
namespace Magicodes.Admin.Core.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_Administration_OrganizationUnits_MemberBatchDelete =
            "Pages.Administration.OrganizationUnits.MemberBatchDelete";
