...
//           All rights reserved
// 
//           filename : OrganizationUnitAppService_Tests.cs
//           description :
// 
...
using Magicodes.Admin.Application.Organizations;
...
namespace Magicodes.Admin.Tests.Organizations
{
    public class OrganizationUnitAppService_Tests : AppTestBase
    {
        ...
        public async Task Test_RemoveFromOrganizationUnit()
        {
            ...
            UsingDbContext(context =>
            {
                var userOu = context.UserOrganizationUnits.FirstOrDefault(uou =>
                    uou.OrganizationUnitId == ou12.Id && uou.UserId == admin.Id);
