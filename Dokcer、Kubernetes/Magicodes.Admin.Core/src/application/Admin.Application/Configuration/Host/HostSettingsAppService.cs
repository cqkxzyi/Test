...
//           All rights reserved
// 
//           filename : HostSettingsAppService.cs
//           description :
// 
    ...
    public class HostSettingsAppService : SettingsAppServiceBase, IHostSettingsAppService
    {
        ...
        private async Task UpdateBillingSettingsAsync(HostBillingSettingsEditDto input)
        {
            ...
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.HostManagement.BillingAddress,
                input.Address);
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.HostManagement.BillingTaxNumber,
                input.TaxNumber);
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.HostManagement.BillingContact,
                input.Contact);
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.HostManagement.BillingBank, input.Bank);
            await SettingManager.ChangeSettingForApplicationAsync(AppSettings.HostManagement.BillingBankAccount,
                input.BankAccount);
        }
