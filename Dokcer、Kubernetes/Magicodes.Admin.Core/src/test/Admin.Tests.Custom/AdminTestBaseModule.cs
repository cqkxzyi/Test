...
using Magicodes.Admin.Tests.Base.Configuration;
using Magicodes.Admin.Tests.Base.DependencyInjection;
using Magicodes.Admin.Tests.Base.Url;
...
namespace Magicodes.Admin.Tests.Base
{
    ...
    {
        public AdminTestBaseModule(AdminEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
