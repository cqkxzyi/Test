...
using Magicodes.Admin.Tests.Base.TestData;
using Microsoft.EntityFrameworkCore;

namespace Magicodes.Admin.Tests.Base
{
    /// <summary>
    ...
    public abstract class AppTestBase<T> : AbpIntegratedTestBase<T> where T : AbpModule
    {
        ...
        protected TResult UsingDbContext<TResult>(Func<AdminDbContext, TResult> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<TResult> UsingDbContextAsync<TResult>(Func<AdminDbContext, Task<TResult>> func)
        {
        ...
        protected TResult UsingDbContext<TResult>(int? tenantId, Func<AdminDbContext, TResult> func)
        {
            TResult result;
        ...
        protected async Task<TResult> UsingDbContextAsync<TResult>(int? tenantId, Func<AdminDbContext, Task<TResult>> func)
        {
            TResult result;
